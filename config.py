...
OPERATIONAL_DATABASE_PATH = Path(
    _env_str("OPERATIONAL_DATABASE_PATH", str(RESULTS_DIR / "runtime" / "tradingbot.sqlite3"))
)
...
UI_CONTROL_USE_SUDO = _env_bool("UI_CONTROL_USE_SUDO", False)
...
ANALYST_SCAN_INTERVAL_SECS = _env_int("ANALYST_SCAN_INTERVAL_SECS", 300)
ANALYST_BACKGROUND_ANALYSIS_CADENCE = _env_str("ANALYST_BACKGROUND_ANALYSIS_CADENCE", "5m")
...
LLM_BACKGROUND_MODEL = _env_str("LLM_BACKGROUND_MODEL", LLM_MODEL)
LLM_INTERACTIVE_MODEL = _env_str("LLM_INTERACTIVE_MODEL", LLM_MODEL)
...
MIN_CASH_FLOOR = 0.05
POSITION_CAP_MODE = _env_str("POSITION_CAP_MODE", "smooth_nav")  # fixed | smooth_nav
NAV_SCALED_CAP_MIN_NAV = _env_float("NAV_SCALED_CAP_MIN_NAV", 100.0)
NAV_SCALED_CAP_MAX_NAV = _env_float("NAV_SCALED_CAP_MAX_NAV", 500.0)
NAV_SCALED_CAP_MIN_WEIGHT = _env_float("NAV_SCALED_CAP_MIN_WEIGHT", 0.35)
